CCMUTATE_LIB="/home/cs23mtech12010/CCM/CCMutator/llvm-project/build/lib/"
# /home/cs23mtech12010/CCM/CCMutator/llvm-project/build/lib/AtomicRMWPass.so
testLibName="AtomicRMWPass.so"
libraryName="AtomicRMWPass"
cd /home/cs23mtech12010/CCM/CCMutator/llvm-project/build_conda/bin/



echo "Begin Test: Non verbose analyze"
./opt  -load-pass-plugin=/home/cs23mtech12010/CCM/CCMutator/llvm-project/build_conda/lib/AtomicRMWPass.so -passes=AtomicRMWPass /home/cs23mtech12010/CCM/CCMutator/llvm-project/llvm/lib/Transforms/AtomicRMWPass/test/test2.ll
echo ""
...
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -order=0 <test.bc >/dev/null
# echo ""

# echo "Begin Test: -mod and no -order (should fail)"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -pos=0 <test.bc >/dev/null
# echo ""

# echo "Begin Test: just -mod (should fail)"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod <test.bc >/dev/null
# echo ""

# echo "Begin Test: -mod position 1 to monotonic (-order=0) out to out_001.bc"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -pos=1 -order=0 <test.bc >out_001.bc
# llvm-dis out_001.bc
# opt  -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -verbose <out_001.bc >/dev/null
# echo "End Test"

# echo "Begin Test: -mod position 0 to acquire (-order=1) out to out_002.bc"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -pos=0 -order=1 <test.bc >out_002.bc
# llvm-dis out_002.bc
# opt  -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -verbose <out_002.bc >/dev/null
# echo "End Test"

# echo "Begin Test: -mod position 0 to release (-order=2) out to out_003.bc"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -pos=0 -order=2 <test.bc >out_003.bc
# llvm-dis out_003.bc
# opt  -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -verbose <out_003.bc >/dev/null
# echo "End Test"

# echo "Begin Test: -mod position 0 to acquire release (-order=3) out to out_004.bc"
# opt -load-pass-plugin= $CCMUTATE_LIB/$testLibName -passes=AtomicRMW -mod -pos=0 -order=3 <test.bc >out_004.bc
# llvm-dis out_004.bc
