...
#ifndef LLVM_LOCK_UNLOCK_VISIT_H
#define LLVM_LOCK_UNLOCK_VISIT_H
...
public:
    ...
    /// Default constructor.
    LockUnlockVisit() : aliasInfo(nullptr) {}

    /// Overridden visitor function for call instructions
    void visitCallInst(CallBase &I);
...
#endif // LLVM_LOCK_UNLOCK_VISIT_H
