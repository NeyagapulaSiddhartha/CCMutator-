CCMUTATE_LIB="/home/cs23mtech12010/CCM/CCMutator/llvm-project/build_conda/bin/lib/Transforms"

# testLibName="Load.so"
# libraryName="loadpass
...
./opt  -S -load-pass-plugin=/home/cs23mtech12010/CCM/CCMutator/llvm-project/build_conda/lib/Load.so -p=loadpass -verbose /home/cs23mtech12010/CCM/CCMutator/llvm-project/llvm/lib/Transforms/Load/test/test.ll -o /home/cs23mtech12010/CCM/CCMutator/llvm-project/llvm/lib/Transforms/Load/test/out.ll
echo ""
...
# echo "Begin Test: -mod position 0,1,2 to order=0,3 out to out_006.bc"
# opt -load $CCMUTATE_LIB/$testLibName $libraryName -mod -pos=0,1,2 -order=0,3 <test.bc >out_006.bc
# llvm-dis out_006.bc
# echo ""
